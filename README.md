...
Три связанные realtime-страницы:

- `/admin/boy/` — внесение денег за мальчика, история и отмена записей этой стороны.
- `/admin/girl/` — внесение денег за девочку, история и отмена записей этой стороны.
...
- http://localhost:8080/admin/boy/
- http://localhost:8080/admin/girl/
